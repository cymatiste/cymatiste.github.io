...
function randomPastelGradient(direction){
   return randomGradient(direction, "#ffffaa", xstnt.Colors.randomWhite);
}
...
function randomGradient(direction, startingColor, colorFunc, numColors){
    ...
    var spaceUsed = 5 + Math.floor(Math.random()*30);
    //var firstWhite = startingColor+" "+spaceUsed+"%";
    var firstCol = xstnt.Colors.variationsOn(startingColor,100)+" "+spaceUsed+"%";

    //var gradientString = "linear-gradient("+direction+", "+firstWhite;
    var gradientString = "radial-gradient(circle at left, "+firstCol;
...
document.body.style.background = randomPastelGradient(randomAngle(95,200)+"deg");
